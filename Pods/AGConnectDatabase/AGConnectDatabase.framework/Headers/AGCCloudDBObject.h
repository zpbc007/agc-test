...
/**
 Basic data type: auto increament int.
 */
@protocol AGCAutoIncrementInt

@end

/**
 Basic data type: auto increament long.
 */
@protocol AGCAutoIncrementLong

@end

@interface NSNumber () <AGCBool, AGCByte, AGCShort, AGCInt, AGCLong, AGCFloat, AGCDouble, AGCAutoIncrementInt, AGCAutoIncrementLong>
